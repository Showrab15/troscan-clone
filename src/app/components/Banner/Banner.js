...
export default function Banner() {
  return (
    <section className="relative h-screen flex items-center justify-center text-center overflow-hidden">
      ...
      >
        <h1 className="text-[40px] md:text-[96px] font-normal text-[#FFFFFFFF]
         md:leading-[96px] leading-none">
          Timeless Comfort & Endless Luxury
        </h1>

        <div className="mt-8 md:flex-row flex flex-col md:flex-wrap gap-4 justify-center">
          <Link
            href="#vision"
          ...
          <Link
            href="#expertise"
            className="border border-[#RRGGBB] text-[#f8ede3] px-6 py-3 rounded-[5px] font-medium
             hover:bg-[#f8ede3] hover:text-[#8D493A]"
          >
            Explore Expertise
          </Link>
        </div>
